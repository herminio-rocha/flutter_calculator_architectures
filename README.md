...
<p>Este projeto foi elaborado para demonstrar como <em>arquiteturas diferentes</em> (MVC, MVVM e MVI) lidam com os mesmos desafios de forma única, destacando boas práticas de desenvolvimento e organização de código.</p>
...
<ul>
    <li><strong>calculator_mvc</strong>: Implementação do padrão arquitetural MVC (Model-View-Controller). A lógica de apresentação e o controle de dados são separados de forma clara, com cada responsabilidade isolada em sua camada.</li>
    <li><strong>calculator_mvvm</strong>: Implementação do padrão arquitetural MVVM (Model-View-ViewModel). A comunicação entre o modelo e a interface de usuário é feita através do ViewModel, permitindo maior desacoplamento e facilitando testes e manutenção.</li>
    <li><strong>calculator_mvi</strong>: Implementação do padrão arquitetural MVI (Model-View-Intent). A interação entre a UI e o modelo é simplificada por meio de intents e estados, promovendo maior previsibilidade e controle de fluxo.</li>
</ul>
...
<ul>
    ...
    <li><strong>test</strong>: Testes unitários e de integração, com foco em testar as funcionalidades e garantir a qualidade do código.</li>
    <li><strong>assets</strong>: Arquivos de recursos, como imagens e fontes usadas no projeto.</li>
</ul>
...
<h2>📞 Contato</h2>
<p>
  Ficarei feliz em receber feedbacks, esclarecer dúvidas ou apenas bater um papo, Para entrar em contato, utilize as informações abaixo:
</p>
<ul>
...
<p>This project was designed to demonstrate how <em>different architectures</em> (MVC, MVVM, and MVI) tackle the same challenges in unique ways, highlighting development best practices and code organization.</p>
...
<h2>🏗️ Structure and Architectures</h2>
<p>This project is organized as follows, with each architecture isolated in its own directory for easy navigation:</p>
<ul>
    <li><strong>calculator_mvc</strong>: Implementation of the MVC (Model-View-Controller) architectural pattern. The presentation logic and data control are clearly separated, with each responsibility isolated in its layer.</li>
    <li><strong>calculator_mvvm</strong>: Implementation of the MVVM (Model-View-ViewModel) architectural pattern. Communication between the model and the user interface is done through the ViewModel, enabling greater decoupling and facilitating testing and maintenance.</li>
    <li><strong>calculator_mvi</strong>: Implementation of the MVI (Model-View-Intent) architectural pattern. Interaction between the UI and the model is simplified through intents and states, promoting greater predictability and flow control.</li>
</ul>
...
<p>Within each directory, the code structure follows best practices for organization and clarity. Each architecture has its own particularities, such as folder organization and responsibility separation, with the main directories organized as follows:</p>
<ul>
    <li><strong>lib</strong>: The project source code, including the implementation of each architecture.</li>
    <li><strong>test</strong>: Unit and integration tests, focusing on testing functionalities and ensuring code quality.</li>
    <li><strong>assets</strong>: Resource files, such as images and fonts used in the project.</li>
</ul>
...
<h2>📞 Contact</h2>
<p>
  I would be happy to receive feedback, answer questions, or simply have a conversation. Feel free to reach out using the contact information below:
</p>
<ul>
  <li><strong>E-mail:</strong> <a href="mailto:herminio.rocha@outlook.com.br">herminio.rocha@outlook.com.br</a></li>
  <li><strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/herminio-rocha-9325a2137" target="_blank">Herminio Rocha</a></li>
